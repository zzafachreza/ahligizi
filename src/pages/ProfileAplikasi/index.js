       ...
       <ScrollView>
        <View style={{padding:10, marginTop:'5%',}}>
            ...
            <View style={{padding:1, backgroundColor:'black',}}></View>
                  ...
                  {/*   Riwayat Pendidikan */}
                  <View style={{flexDirection:"row", marginTop:-10, padding:10, alignItems:"center", justifyContent:"flex-start"}}>
                  <Text style={{fontFamily:fonts.primary[600], fontSize:MyDimensi/4., }}>Riwayat Pendidikan : <Text style={{fontFamily:fonts.primary[400], fontSize:MyDimensi/5.8, }}>{'\n'}• Diploma III Gizi Poltekkes Kemenkes Yogyakarta 2012
{'\n'}• Diploma IV Gizi Poltekkes Kemenkes Yogyakarta 2013{'\n'}• Magister Manajemen Universitas Mulawarman 2022{'\n'}• Profesi Dietisien Poltekkes Kemenkes Malang (On Process)</Text></Text> 
