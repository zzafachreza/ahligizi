      ...
      <ScrollView>
        ...
        <View style={{ padding: 10, }}>
          ...
          <View style={{ flexDirection: "row", padding: 10, justifyContent: "space-around" }}>
            ...
            <TouchableNativeFeedback onPress={() => navigation.navigate('MakananBalita')}>
              <View style={{
                padding: 10, backgroundColor: colors.primary, height: 100, width: 100, borderRadius: 50,
                flexDirection: "row",
                justifyContent: "center",
                alignItems: 'center',
                ...
                <View style={{}}>
                  <Image source={require('../../assets/makananbalita.png')} style={{
                    height: 50, width: 50, alignItems: "center",
                    alignSelf: "center", marginTop: "60%"
                  }} />
                  <Text style={{ fontFamily: fonts.primary[600], textAlign: 'center', top: 30, fontSize: MyDimensi / 4.5 }}>Makanan Balita</Text>
                </View>
              </View>
            </TouchableNativeFeedback>


            <TouchableNativeFeedback onPress={() => navigation.navigate('Makananibuhamil')}>
              <View style={{
                padding: 10, backgroundColor: colors.primary, height: 100, width: 100, borderRadius: 50,
                flexDirection: "row",
                justifyContent: "center",
                ...
                <View style={{}}>
                  <Image source={require('../../assets/makananibuhamil.png')} style={{
                    height: 50, width: 50, alignItems: "center",
                    alignSelf: "center", marginTop: "60%"
                  }} />
                  <Text style={{ fontFamily: fonts.primary[600], textAlign: 'center', top: 30, fontSize: MyDimensi / 4.5 }}>Makanan Ibu Hamil</Text>
                </View>
              </View>
            </TouchableNativeFeedback>
          ...
          <View style={{ flexDirection: "row", padding: 10, justifyContent: "space-around" }}>
            ...
            <TouchableNativeFeedback onPress={() => navigation.navigate('KonsultasiOnline')}>
              <View style={{
                padding: 10, backgroundColor: colors.primary, height: 100, width: 100, borderRadius: 50,
                flexDirection: "row",
                justifyContent: "center",
                ...
                <View style={{}}>
                  <Image source={require('../../assets/konsultasionline.png')} style={{
                    height: 50, width: 50, alignItems: "center",
                    alignSelf: "center", marginTop: "60%"
                  }} />
                  <Text style={{ fontFamily: fonts.primary[600], textAlign: 'center', top: 30, fontSize: MyDimensi / 4.5 }}>Konsultasi Online</Text>
                </View>
              </View>
            </TouchableNativeFeedback>


            <TouchableNativeFeedback onPress={() => navigation.navigate('ProfileAplikasi')}>
              <View style={{
                padding: 10, backgroundColor: colors.primary, height: 100, width: 100, borderRadius: 50,
                flexDirection: "row",
                justifyContent: "center",
                ...
                <View style={{}}>
                  <Image source={require('../../assets/profilepembuataplikasi.png')} style={{
                    height: 50, width: 50, alignItems: "center",
                    alignSelf: "center", marginTop: "90%"
                  }} />
                  <Text style={{ fontFamily: fonts.primary[600], textAlign: 'center', top: 30, fontSize: MyDimensi / 4.5 }}>Profile Pembuat Aplikasi </Text>
                </View>
              </View>
            </TouchableNativeFeedback>
          </View>
